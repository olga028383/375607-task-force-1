    ...
    <section class="modal enter-form form-modal" id="enter-form">
        ...
        <?php $form = ActiveForm::begin(['id' => 'login-form', 'enableAjaxValidation' => true]); ?>
            ...
            <?= $form->field($model, 'email', array(
                'options' => array('class' => 'field-group field-group--login', 'tag' => 'p'),
                'labelOptions' => array('for' => 'loginform-email', 'class' => 'form-modal-description'),
                'errorOptions' => array('tag' => 'span')

            ))->textInput(['autofocus' => true, 'class'=> 'enter-form-email input input-middle']) ?>


        <?= $form->field($model, 'password', array(
            'options' => array('class' => 'field-group field-group--login', 'tag' => 'p'),
            'labelOptions' => array('for' => 'loginform-password', 'class' => 'form-modal-description'),
            'errorOptions' => array('tag' => 'span')

        ))->passwordInput(['class'=> 'enter-form-email input input-middle', 'style' => 'display: block']) ?>
